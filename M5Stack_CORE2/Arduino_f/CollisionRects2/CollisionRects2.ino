...
//                    , a->r >> SHIFTSIZE
//                    , a->color);
    sprite->fillRect( (a->x >> SHIFTSIZE) - (a->r >> SHIFTSIZE) 
                    , (a->y >> SHIFTSIZE) - (a->r >> SHIFTSIZE)
                    , (a->r >> SHIFTSIZE) * 2
                    , (a->r >> SHIFTSIZE) * 2
                    , a->color);
    sprite->fillCircle( (a->x >> SHIFTSIZE) - ((a->r >> SHIFTSIZE) / 2)
                      , (a->y >> SHIFTSIZE) - ((a->r >> SHIFTSIZE) / 2)
                      , (a->r >> SHIFTSIZE) / 3
                      , TFT_BLACK);
    sprite->fillCircle( (a->x >> SHIFTSIZE) + ((a->r >> SHIFTSIZE) / 2)
                      , (a->y >> SHIFTSIZE) - ((a->r >> SHIFTSIZE) / 2)
                      , (a->r >> SHIFTSIZE) / 3
                      , TFT_BLACK);
    sprite->fillRect( (a->x >> SHIFTSIZE) - ((a->r >> SHIFTSIZE) / 2)
                    , (a->y >> SHIFTSIZE) + ((a->r >> SHIFTSIZE) / 2)
                    , (a->r >> SHIFTSIZE)
                    , (a->r >> SHIFTSIZE) / 3
                    , TFT_BLACK);
