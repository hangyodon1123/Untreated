...
void microPhoneSetup()
{
    ...
    DisFFTbuff.createSprite(311,179);
}
...
void MicroPhoneFFT()
{
    ...
    DisFFTbuff.fillRect(0,0,311,179,DisFFTbuff.color565(0x33,0x20,0x00));
    ...
    for( int x = 0; x < 24; x++ )  {
        for( int y = 0; y < 9; y++ )  {
            ...
            DisFFTbuff.fillRect(x*13,179-y*20 - 17,10,17,colorRect);
        }
    }
    DisFFTbuff.pushSprite(5,40);
}
...
void setup()
{
    ...
    M5.Lcd.fillRect(0,0,320,30,TFT_GREEN);
    M5.Lcd.fillRect(0,30,320,5,TFT_BLACK);
    M5.Lcd.fillRect(0,225,320,5,TFT_BLACK);
    M5.Lcd.fillRect(0,230,320,14,TFT_GREEN);

    M5.Lcd.setTextSize(1);
    M5.Lcd.setTextColor(TFT_BLACK);
    M5.Lcd.setFreeFont(&EVA_20px);
    M5.Lcd.drawString("SOUND FFT",28,5);
